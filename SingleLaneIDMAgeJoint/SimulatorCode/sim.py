from SingleLaneIDMAgeJoint.SimulatorCode.tfLight import RandomIntervalGenerator
import random
...
class TrafficSim(gym.Env):
    ...
    def init_render(self):
        ...
        self.red_light = pygame.image.load(
            os.getcwd() + "/" + "SingleLaneIDM/SimulatorCode/images/red.png").convert_alpha()
        self.green_light = pygame.image.load(
            os.getcwd() + "/" + "SingleLaneIDM/SimulatorCode/images/green.png").convert_alpha()
    ...
    def step(self, rec):
        ...
        self.occChangeDetector(prev_occ, self.occ_grid, prev_occ, self.vel_grid, self.detect_change)
        ...
        #print(comm_obs)
        #print("Local View :", self.local_indexes)
